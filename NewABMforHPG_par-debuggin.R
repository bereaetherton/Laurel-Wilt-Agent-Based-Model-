...
#-------------------------------------------------------------------------------#
setwd("/Users/ricardoi/git_db/Laurel-Wilt-Agent-Based-Model-/")
#Files and unchanged parameters
...
size<-dim(av.centers)[1] #size of adjacency matrix
...
#assigning random management strats between simulations
  ...
  # Histogram of example data and normalized/rescaled data
  par(mfrow=c(1,2))
  hist(social.net, breaks=10, xlab="social.net", col="lightblue", main="")
  hist(rescaled.social.net, breaks=10, xlab="rescaled social.net", col="lightblue", main="")
